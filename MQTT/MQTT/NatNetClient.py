...
class NatNetClient:
    ...
    def __init__( self ):
        ...
        #self.server_ip_address = "<NATNET_SERVER_IP>"
        self.server_ip_address = "<NATNET_SERVER_IP>"

        # Change this value to the IP address of your local network interface
        #self.local_ip_address = "127.0.0.1"
        self.local_ip_address = "<LOCAL_INTERFACE_IP>"

        # This should match the multicast address listed in Motive's streaming settings.
        self.multicast_address = "<NATNET_MULTICAST_ADDRESS>"
...
#Unpack Mocap Data Functions
            ...
            for i in range( 0, device_count ):
                ...
                for j in range( 0, device_channel_count ):
                    ...
                    for k in range( 0, device_channel_frame_count ):
                        device_channel_val = int.from_bytes( data[offset:offset+4], byteorder='little',  signed=True )
    ...
    def __unpack_rigid_body_description( self, data, major, minor):
        ...
        if (major >= 3) or (major == 0) :
            ...
            for marker in marker_count_range:
                ...
                # Active Label
                active_label = int.from_bytes(data[offset2:offset2+4],byteorder = 'little', signed=True)
                offset2 += 4
    ...
    def __unpack_force_plate_description(self, data, major, minor):
        ...
        if major >= 3:
            ...
            channel_data_type = int.from_bytes( data[offset:offset+4], byteorder='little',  signed=True )
            offset+=4
    ...
    def __unpack_asset_marker_data( self, data, major, minor ):
        ...
        marker_data = MoCapData.AssetMarkerData(marker_id, pos, marker_size, marker_params, residual)
